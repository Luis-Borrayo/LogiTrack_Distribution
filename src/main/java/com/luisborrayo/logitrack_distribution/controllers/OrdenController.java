...
public class OrdenController {
    ...
    public Response getOrderById(@PathParam("id") Long id) {
        ...
        OrderResponseDto orderDto = ordenService.toOrderResponseDto(order.get());
    ...
    public Response getCustomerDebt(@PathParam("customerId") Long customerId) {
        BigDecimal debt = ordenService.getTotalDebtByCustomer(customerId);
    ...
    public Response createOrder(CreateOrdenDto orderDto) {
        ...
        OrderResponseDto orderResponse = ordenService.toOrderResponseDto(createdOrder.get());
    ...
    public Response updateOrderStatus(@PathParam("id") Long id, StatusUpdateRequest statusRequest) {
        ...
        OrderResponseDto orderResponse = ordenService.toOrderResponseDto(updatedOrder.get());
